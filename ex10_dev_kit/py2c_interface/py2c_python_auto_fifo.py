...
# IPJ_autogen | gen_c2python_fifo_data {
class EventPacketType(IntEnum):
    ...
    Halted = 14
    InvalidPacket = 240
    FifoOverflowPacket = 241
    Ex10ResultPacket = 242
...
class TagRead(Structure):
    ...
    ('rx_gain_settings', c_uint16),
    ('type', c_uint8),
    ('tid_offset', c_uint8),
    ('halted_on_tag', c_bool, 1),
    ('memory_parity_err', c_bool, 1),
    ('packet_rfu_1', c_uint8, 6),
    ('packet_rfu_2', c_uint8),
    ]
...
class AggregateOpSummary(Structure):
    ...
    ('identifier', c_uint16),
    ('last_inner_command_run', c_uint8),
    ('last_inner_command_error', c_uint8),
    ]
...
class FifoOverflowPacket(Structure):
    _pack_ = 1
    _fields_ = [
    ('num_bytes_over', c_uint16),
    ('overflowing_packet_type', c_uint8),
    ('rfu', c_uint8),
    ]

class Ex10ResultPacket(Structure):
    _pack_ = 1
    _fields_ = [
    ('ex10_result', Ex10Result),
    ]
...
class PacketData(Union):
    _fields_ = [
        ...
        ('fifo_overflow_packet', FifoOverflowPacket),
        ('ex10_result_packet', Ex10ResultPacket),
