...
static const struct RssiCompensationLut rssi_compensation = {
    // clang-format off
    .rf_modes = {   1,  124,  323,    3,
                  123,  222,  324,    5,
                  141,  241,  342,    7,
                  146,  244,  343,   11,
                  102,  302,   12,  125,
    ...
    // clang-format on
    .rf_mode_to_rx_mode =
        {RX_MODE_12_IDX, RX_MODE_12_IDX, RX_MODE_12_IDX, RX_MODE_11_IDX,
         RX_MODE_11_IDX, RX_MODE_11_IDX, RX_MODE_11_IDX, RX_MODE_17_IDX,
         RX_MODE_17_IDX, RX_MODE_17_IDX, RX_MODE_17_IDX, RX_MODE_16_IDX,
         RX_MODE_16_IDX, RX_MODE_16_IDX, RX_MODE_16_IDX, RX_MODE_6_IDX,
         RX_MODE_6_IDX,  RX_MODE_6_IDX,  RX_MODE_11_IDX, RX_MODE_11_IDX,
         RX_MODE_11_IDX, RX_MODE_11_IDX, RX_MODE_21_IDX, RX_MODE_21_IDX,
         RX_MODE_21_IDX, RX_MODE_21_IDX, RX_MODE_18_IDX, RX_MODE_18_IDX,
         RX_MODE_18_IDX, RX_MODE_6_IDX,  RX_MODE_18_IDX, RX_MODE_18_IDX,
         RX_MODE_12_IDX, RX_MODE_23_IDX, RX_MODE_23_IDX, RX_MODE_23_IDX,
         RX_MODE_11_IDX, RX_MODE_11_IDX, RX_MODE_11_IDX, RX_MODE_5_IDX,
         RX_MODE_21_IDX, RX_MODE_44_IDX, RX_MODE_18_IDX, RX_MODE_12_IDX,
         RX_MODE_11_IDX, RX_MODE_48_IDX, RX_MODE_21_IDX, RX_MODE_51_IDX,
         RX_MODE_21_IDX, RX_MODE_21_IDX, RX_MODE_5_IDX,  RX_MODE_51_IDX},
    .rx_modes_blf_khz =
        {
            426,
            640,
    ...
    .rx_mode_digital_correction =
        {
            ...
            // 44
            {
                82,   -445, -527, -562, -563, -557, -550, -535, -515, -488,
                -450, -414, -386, -368, -350, -324, -295, -262, -237, -226,
                -187, -155, -129, -106, -87,  -73,  -63,  -56,  -45,  -41,
                -37,  -28,  -20,  -10,  -2,   5,    13,   20,   22,   27,
                29,   32,   36,   37,   39,   38,   41,   38,   15,   -230,
                -374, -324, -300, -273, -224, -169, -122, -71,  -29,  14,
                55,   91,   128,  165,
            },
            // 48
            {
                50,   -480, -560, -594, -593, -583, -567, -536, -501, -457,
                -426, -396, -360, -324, -284, -244, -207, -177, -161, -154,
                -136, -123, -111, -100, -85,  -71,  -62,  -50,  -38,  -33,
                -27,  -18,  -9,   2,    10,   17,   21,   26,   27,   25,
                21,   10,   -7,   -35,  -73,  -120, -179, -253, -534, -466,
                -404, -356, -325, -301, -243, -188, -141, -97,  -50,  -11,
                30,   68,   103,  139,
            },
        },
    .lbt_digital_correction = -40,
