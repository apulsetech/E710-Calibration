...
/**
 * @file continuous_inventory_use_case_antenna_disconnect_example.c
...
{
    ex10_ex_printf(
        "Starting continuous inventory use case with antenna disconnect "
        "example\n");
    ...
    // Install antenna disconnect module
        ...
        if (ex10_result.error)
        {
            ...
            if (ex10_result.module == Ex10AntennaDisconnect)
            {
                ...
                ex10_eprintf(
                    ...
                    "%d\n",
                    antenna_disconnect->get_last_reverse_power_adc(),
                    antenna_disconnect->get_last_reverse_power_adc_threshold());
            }
        }
    }
    else
